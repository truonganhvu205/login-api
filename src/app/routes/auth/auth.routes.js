...
router.post('/register', validateRegisterInput, verifyUserRegister, authController.userRegister)
router.get('/register-get', authController.userRegisterGet)

router.post('/login', validateLoginInput, verifyUserLogin, authController.userLogin)
